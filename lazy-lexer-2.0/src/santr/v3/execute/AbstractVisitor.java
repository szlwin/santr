...
public abstract class AbstractVisitor implements Visitor{
	...
	protected final List<Object> getAllChildValue(Context context) throws ExecuteInvaildException{
		return getAllChildValue(context,null);
	}
	
	protected final List<Object> getAllChildValue(Context context,Object param) throws ExecuteInvaildException{
		List<RTree> subTreeList = context.getAllChild();
	...
	protected final List<Object> getChildValueByName(Context context,String name) throws ExecuteInvaildException{
		return getChildValueByName(context,name,null);
		
	}
	
	protected final List<Object> getChildValueByName(Context context,String name,Object param) throws ExecuteInvaildException{
		List<RTree> subTreeList = context.getAllChild();
		List<Object> treeList = new FastTable<Object>();
	...
	protected final Object getChildValue(Context context,int index,Object param) throws ExecuteInvaildException{
	...
	protected final Object getChildValue(Context context,int index) throws ExecuteInvaildException{
	...
	private void vist(RTree rTree, Object param) throws ExecuteInvaildException {
